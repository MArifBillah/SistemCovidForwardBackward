...
<div  class='jenis-prioritas'>
        <h1> PRIORITAS RENDAH</h1>
    </div>

<form action="rule.php" method="get">

<?php
$result = mysqli_query($mysqli, "SELECT DISTINCT pertanyaan,codename FROM covid WHERE nama_varian IN ('Varian awal SARS-CoV-19','Flu-like dengan demam') AND pertanyaan IS NOT NULL");
echo "<table border=1>";
